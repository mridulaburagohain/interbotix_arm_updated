...
- interbotix_xsarms_description - Please check the ```README``` file of this package to have detailed information on the changes performed: [Xsarms description](https://github.com/mridulaburagohain/interbotix_arm_updated/tree/main/interbotix_ros_manipulators/interbotix_ros_xsarms/interbotix_xsarm_descriptions)
