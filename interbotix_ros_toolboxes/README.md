...
- The **interbotix_moveit_interface** module is responsible to initialize to the moveGroupInterface, create services like moveit_plan and clear_markers and uses the GUI interpretations control the arm.
